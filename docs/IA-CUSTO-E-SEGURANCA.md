...
**O consumo é baixo por desenho.** O Seer é feito para poucas pessoas usando o assistente ao mesmo tempo, não para milhares de acessos simultâneos. Cada pergunta leva só um resumo (o top 10 da fila ou um cliente), e não a base inteira, então o volume de texto processado é pequeno e não cresce com o tamanho da carteira.
