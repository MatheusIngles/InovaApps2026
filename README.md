...
No servidor, o app e a fila rodam como serviços do systemd (`deploy/`), que sobem no boot, reiniciam se caírem e são verificados a cada minuto. Passo a passo em [app/README.md](app/README.md).
