...
class FilaTable extends TableWidget
{
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->description('Mesma ordem da lista de clientes: quem já está em alerta primeiro e, em cada grupo, atenção × valor mensal do contrato (equilíbrio em Configurações). Ordena a fila; não prevê cancelamento ou perda.')
            ...
            ->columns([
                ...
                TextColumn::make('nivel')->label('Nível')->badge()->state(fn (Customer $e) => $e->rotulo())
                    ->color(fn (string $state) => ['Crítico' => 'danger', 'Alto' => 'warning', 'Médio' => 'info', 'Sem avaliação' => 'gray'][$state] ?? 'success'),
