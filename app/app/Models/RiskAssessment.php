...
#[Fillable(['customer_id', 'reference_month', 'risk_probability', 'priority_score', 'expected_revenue_at_risk', 'confidence', 'signals_json', 'recommended_action_json', 'model_version', 'calculated_at'])]
