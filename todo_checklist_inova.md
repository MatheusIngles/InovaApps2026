...
- [x] **Tenant-Specific Login Screen**
...
- [x] **Context-Isolated Chat System**
...
- [x] **Priority & Parameter Settings Screen**
...
- [x] **Recalculate & Refactor Base Metric Logic**
...
- [x] **Company Configuration Controller**
  - CRUD operations for metric weights, UI theme settings, and isolated chat settings.

---

## 🧪 6. Refactoring & Testing
- [x] Review base metric calculation performance and accuracy against edge-case spreadsheets.
- [x] Verify data isolation security checks on all multi-tenant endpoints.
